...
const ServicesDetails = () => {
  ...
  return (
    <main className={styles.services_details_container}>
      <div className={styles.services_details_container_wrapper}>
        ...
        <section className={styles.details_body}>
          <p className={styles.header_paragraph}>
            At Bridge Bright Center, our Behavioral Therapy program is designed
            to support children in overcoming emotional and behavioral
            challenges that may impact their well-being, relationships, and
            daily functioning. Our approach is rooted in compassion and
            expertise, focusing on empowering children to develop positive
            coping strategies, emotional regulation skills, and healthier
            behaviors.
          </p>
          ...
          <p className={styles.section_paragraph}>
            ...
            plans are personalized to meet the individual needs and
            circumstances of each child. Our skilled therapists use
            evidence-based practices, including Cognitive Behavioral Therapy
            (CBT), Applied Behavior Analysis (ABA), and other integrative
            techniques to address specific behavioral concerns. Sessions are
            conducted in a safe, supportive environment where children feel
            comfortable expressing their emotions and thoughts.
            <br /> <br />
          ...
          <ul className={styles.list_container}>
            ...
            <li>
              Better Communication of Needs and Feelings: Children are
              encouraged to express their thoughts constructively, reducing
